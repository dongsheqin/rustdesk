...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "MiDeski võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa MiDesk mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et MiDesk oma süsteemi paigaldada."),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb MiDeskile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb MiDeskile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma MiDeskile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [MiDesk Input] sisse."),
        ...
        ("doc_mac_permission", "https://MiDesk.com/docs/en/manual/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele MiDesk rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma MiDeskile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma MiDeskile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud MiDeski kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("install_cert_tip", "Paigalda MiDesk sertifikaat"),
        ("confirm_install_cert_tip", "See on MiDeski testimise sertifikaat, mida võib usaldada. Sertifikaati kasutatakse vajadusel MiDeski draiverite usaldamiseks ja paigaldamiseks."),
        ...
        ("verify_rustdesk_password_tip", "Kinnita MiDeski parooli"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul MiDeski kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda MiDesk Server Pro versioonile {} või uuem!"),
        ("pull_group_failed_tip", "Grupi värskendamine ebaõnnestus"),
        ("doc_fix_wayland", "https://MiDesk.com/docs/en/manual/linux/#x11-required"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib MiDeskil takistada juhitud poolel toimimist."),
