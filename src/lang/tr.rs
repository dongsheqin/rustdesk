...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, MiDesk bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, MiDesk'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ...
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için MiDesk'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için MiDesk'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, MiDesk'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [MiDesk Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep RustDesk background service", "MiDesk arka plan hizmetini sürdürün"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için MiDesk'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için MiDesk'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan MiDesk'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("install_cert_tip", "MiDesk sertifikasını yükleyin"),
        ("confirm_install_cert_tip", "Bu, güvenilir olabilecek bir MiDesk test sertifikasıdır. Sertifika, gerekli olduğunda MiDesk sürücülerini güvenilir ve yüklemek üzere kullanacaktır."),
        ...
        ("verify_rustdesk_password_tip", "MiDesk parolasını doğrulayın"),
